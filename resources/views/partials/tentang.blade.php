            ...
            <div class="container">
                <div class="row_item align_item">
                    <div class="con_lenght info_title_content aos-init aos-animate" data-aos="fade-right" data-aos-duration="1500">
                        <h4 class="font-l cl_white left_contenttext">GAS adalah aplikasi untuk memudahkan pelaku usaha menjangkau calon pembeli lebih luas. Melalui gerakan #AyoBelanjaTokoTetangga GAS mengajak untuk menjelajah dan mendukung usaha-usaha di sekitarmu.</h4>
                    </div><!-- end con_lenght -->
                        ...
                        <div class="slideImg carousel scrolling">
                            <div class="imageslide carousel-item active" style="z-index: 0; opacity: 0.894122; visibility: visible; transform: translateX(9px) translateY(-11.5px) translateX(39.0691px) translateX(0px) translateZ(-31.7635px);">
                                <div class="inblk">
                                    ...
                                    <div class="imgslide_content">
                                        <img src="https://gas.id/files/images/gambar-toko_1616661355.png">
                                    </div>
                                    <div class="descslide_content list_desc_job">
                                        <ul class="dod_job">
                                            <li>Tingkatkan pendapatan tokomu.</li><li>Jangkau pembeli lebih luas.</li><li>Bantu Kelola barang siap jualmu.</li>                                                    </ul>
                                    </div>
                                </div>
                            ...
                            <div class="imageslide carousel-item" style="transform: translateX(9px) translateY(-11.5px) translateX(285.069px) translateZ(-231.763px); z-index: -1; opacity: 0.227455; visibility: visible;">
                                <div class="inblk">
                                    ...
                                    <div class="imgslide_content">
                                        <img src="https://gas.id/files/images/gambar-driver_1616661412.png">
                                    </div>
                                    <div class="descslide_content list_desc_job">
                                        <ul class="dod_job">
                                            <li>Tanpa biaya daftar</li><li> tinggal daftar.</li><li>Biaya ongkir jadi milik tokomu.</li>                                                    </ul>
                                    </div>
                                </div>
                            </div><!-- end carousel-item-->
                            <div class="imageslide carousel-item" style="transform: translateX(9px) translateY(-11.5px) translateX(-206.931px) translateZ(-168.237px); z-index: -1; opacity: 0.439212; visibility: visible;">
                                <div class="inblk">
                                    ...
                                    <div class="imgslide_content">
                                        <img src="https://gas.id/files/images/gambar-pembeli_1616661475.png">
                                    </div>
                                    <div class="descslide_content list_desc_job">
                                        <ul class="dod_job">
                                            <li>Pesan belanjaan dari rumah. </li><li>Layanan antar murah.</li><li>Harga barang asli tanpa biaya admin.</li>                                                    </ul>
                                    </div>
                                </div>
                            </div><!-- end carousel-item-->
                        </div><!-- end carousel -->
